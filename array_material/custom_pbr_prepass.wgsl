...
fn prepass_alpha_discard(in: FragmentInput) {
    ...
    if (bevy_pbr::pbr_bindings::material.flags & bevy_pbr::pbr_types::STANDARD_MATERIAL_FLAGS_BASE_COLOR_TEXTURE_BIT) != 0u {
        #ifdef ARRAY_TEXTURE
          output_color = output_color * textureSampleBias(bevy_pbr::pbr_bindings::base_color_texture, bevy_pbr::pbr_bindings::base_color_sampler, in.uv, in.layer, bevy_pbr::prepass_bindings::view.mip_bias);
        #else
